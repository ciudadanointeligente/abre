...
Setting.create(key: 'facebook_handle', value: 'M.CiudadanoInteligente')
Setting.create(key: 'youtube_handle', value: 'CiudadanoInteligentecl')
Setting.create(key: 'telegram_handle', value: '')
Setting.create(key: 'blog_url', value: '/blog')
Setting.create(key: 'url', value: 'https://abre.CiudadanoInteligente.cl')
Setting.create(key: 'org_name', value: 'Abre')
Setting.create(key: 'municipality_name', value: 'CiudadanoInteligente')
...
Setting.create(key: 'comments_body_max_length', value: '1000')
Setting.create(key: 'mailer_from_name', value: 'Abre Ciudadano Inteligente')
Setting.create(key: 'mailer_from_address', value: 'abre@CiudadanoInteligente.cl')
...
Setting.create(key: 'logo', value: 'logo-fci.png')
Setting.create(key: 'color', value: '#29CDB5')
